...
def build_model_dir(hidden_units, learn_rate, features):
    ...
    result_string += "_lr"
    result_string += '-' + str(learn_rate)[2:]
...
def run(warm_start=False,
    ...
    model_dir = TMP + '/' + build_model_dir(hidden_units, learn_rate, features)

    warm_start_from = None
    if warm_start is True:
        warm_start_from = model_dir + '/checkpoint'
    ...
    if pred:
        ...
        write_predictions(
            ...
            out_file=model_dir+'/predict.csv'
            )
